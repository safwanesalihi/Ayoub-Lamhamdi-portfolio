...
export default function AboutPage() {
  return (
    <main className="relative">
      ...
      {/* ── Hero + Bio: portrait left, all content right ─────── */}
      <section className="relative grid grid-cols-12 gap-0">

        {/* Left — portrait, sticky on desktop */}
        <div className="relative col-span-12 order-1 h-[60svh] md:sticky md:top-0 md:col-span-6 md:h-[100svh]">
          <Image
        ...
        {/* Right — heading + full bio + stats */}
        <div className="col-span-12 order-2 flex flex-col gap-8 px-edge py-10 md:col-span-6 md:min-h-[100svh] md:gap-10 md:py-16">
          {/* Top: title block */}
          <div>
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            {/* Stats */}
            <div className="grid grid-cols-3 gap-6 border-t border-line/60 pt-8 md:gap-10 md:pt-10">
              {[
